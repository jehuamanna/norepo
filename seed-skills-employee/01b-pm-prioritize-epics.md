...
(`cascade_stop: false`); your backlog ships alongside the rest of the
run as an advisory ordering. Feature-level decomposition continues
automatically once this artifact is auto-Approved.
