...
//!
//! Plugins are compile-time Rust types. Two trait objects exist: [`NotePlugin`] for note-content
...
//! [`PluginRegistry::note_plugin_for`] and [`PluginRegistry::contributions`] to render their UIs.
...
pub use manifest::{NoteKind, PluginManifest, PluginSurface};
pub use registry::{register_builtins, PluginRegistry};
pub use traits::{NotePlugin, UIPlugin};
